...
type
    ...
    TContour = class
        private
            ...
            procedure CreateContourData(const sumList: TArray<integer>; MaxNum, MinNum: integer; MidNum: double; var Bmp: TBitmap);
        ...
        public
            function GenerateContour(const PedestrianMU: TPedestrianMapUser; CellsIOL: TList<TArray<integer>>;
...
{ TContour }
//==============================================================================
function TContour.GenerateContour(const PedestrianMU: TPedestrianMapUser; CellsIOL: TList<TArray<integer>>;
    StartTime, EndTime: TTime; MinResolution: integer; out MaxNum, MiddleNum, MinNum: integer): TBitmap;
    var
        beginIdx : integer;
        endIdx   : integer;
    ...
    CreateContourData(sumIO, MaxNum, MinNum, tmpMid, ConBmp);
    Result := ConBmp;
    end;

//==============================================================================
procedure TContour.CalcIdxFromSpan(const StTime, EndTime: TTime; MinReso: integer; out BegIdx, EndIdx: integer);
    var
        TTimeMR   : double;
    begin
...
//==============================================================================
procedure TContour.SumDataBeginIdxToEndIdx(const begIdx, endIdx: integer; IOList: TList<TArray<integer>>; out sumList: TArray<integer>);
    var
...
//==============================================================================
function TContour.GetMaxMinMiddlePassedNum(const sumList: TArray<integer>; out MaxNum, MinNum: integer): double;
    var
...
//==============================================================================
procedure TContour.SetRGB(const rVal, gVal, bVal: integer; var r, g, b: integer);
    begin
    r := rVal;
    g := gVal;
    b := bVal;
...
//==============================================================================
procedure TContour.CreateContourData(const sumList: TArray<integer>; MaxNum, MinNum: integer; MidNum: double; var Bmp: TBitmap);
    var
        x, y, r, g, b : integer;
        PassedNum     : integer;
    begin
    ...
    for y := 0 to Bmp.Height - 1 do
        ...
        for x := 0 to Bmp.Width - 1 do
            ...
            else if PassedNum >= Round((MaxNum + Round((MaxNum + MidNum) / 2)) / 2) then
                SetRGB(255, 0, 0, r, g, b)
            else if PassedNum >= Round((MaxNum + MidNum) / 2) then
                SetRGB(255, Trunc(255*(1/3)), 0, r, g, b)
            else if PassedNum >= Round((Round((MaxNum + MidNum) / 2) + MidNum) / 2) then
                SetRGB(255, Trunc(255*(2/3)), 0, r, g, b)
            else if PassedNum >= MidNum then
                SetRGB(255, 255, 0, r, g, b)
            else if PassedNum >= Round((MidNum + Round((MidNum + MinNum) / 2)) / 2) then
                SetRGB(0, 255, 0, r, g, b)
            else if PassedNum >= Round((MidNum + MinNum) / 2) then
                SetRGB(0, Trunc(255*(2/3)), Trunc(255*(1/3)), r, g, b)
            else if PassedNum >= Round((Round((MidNum + MinNum) / 2) + MinNum) / 2) then
                SetRGB(0, Trunc(255*(1/3)), Trunc(255*(2/3)), r, g, b)
            else
                SetRGB(0, 0, 255, r, g, b);
