...
type
    ...
    TPedestrianMapUser = class
        ...
        public
            ...
            procedure ExportObstacleXML(var rootNode : IXMLNode; Elapsed : Integer);
...
procedure TPedestrianMapUser.ExportObstacleXML(var rootNode : IXMLNode; Elapsed : Integer);
    begin
    if not Enabled then
        Exit;

    p_Map.ExportObstacleXML(rootNode, Elapsed);
    end;
