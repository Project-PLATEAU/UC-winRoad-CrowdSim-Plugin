...
type
    ...
    TPedestrianMapList = class
        ...
        public
            constructor Create(const aAPI: IF8ApplicationServices; const aRoadList: TTranRoadList);
...
const
    PEDESTRIAN_MAP_LIST_PLUGIN_DATA = 'PedestrianMapListPluginData';
...
{ TPedestrianMapList }
constructor TPedestrianMapList.Create(const aAPI: IF8ApplicationServices; const aRoadList: TTranRoadList);
    begin
    p_API := aAPI;
