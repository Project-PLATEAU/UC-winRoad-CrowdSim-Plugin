...
type
    ...
    TPedestrianCellGroupBase = class
        ...
        public
            ...
            procedure ExportObstacleXML(var aObstacleSetNode : IXMLNode); virtual;
    ...
    TPedestrianCellGroupAreaMapBase<T: TPedestrianCellGroupBase> = class
        ...
        public
            ...
            procedure ExportObstacleXML(var aRootNode : IXMLNode);
...
procedure TPedestrianCellGroupBase.ExportObstacleXML(var aObstacleSetNode: IXMLNode);
    var
        i: Integer;
    begin
    for i := 0 to Count - 1 do
        Item[i].ExportObstacleXML(aObstacleSetNode);
    end;
...
procedure TPedestrianCellGroupAreaMapBase<T>.ExportObstacleXML(var aRootNode : IXMLNode);
    var
        i: Integer;
    begin
    for i := 0 to p_Lines.Count - 1 do
        p_Lines[i].ExportObstacleXML(aRootNode);
    end;
