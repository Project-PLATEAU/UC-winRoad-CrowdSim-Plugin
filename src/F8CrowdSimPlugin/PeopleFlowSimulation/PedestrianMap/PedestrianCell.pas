...
type
    ...
    TPedestrianCell = class
        private
            ...
            function  GetCenterLocal: TPoint3D;
            function  GetCorner(const aIdx: VertexPositionType): TPointPositionData;
        public
            constructor Create(const aCellID: TCellID;
                               const aMatrix, aMatrixLocal, aMatrixGL: VertexPositions; const aCenterLocal: TPoint3D;
            ...
            property  CenterLocal                           : TPoint3D             read GetCenterLocal;
...
constructor TPedestrianCell.Create(const aCellID: TCellID;
    ...
    p_CenterLocal  := aCenterLocal;
    p_Status       := aStatus;
    end;

function TPedestrianCell.Clone: TPedestrianCell;
    begin
    Result := TPedestrianCell.Create(p_CellID, p_Vertexs, p_VertexsLocal, p_VertexsGL, p_CenterLocal, p_Status);
    end;
...
function TPedestrianCell.GetCenterLocal: TPoint3D;
    begin
    Result := p_CenterLocal;
    end;
