...
procedure TFrameControlTime.ActionStopExecute(Sender: TObject);
    ...
    p_controller.Stop;
    p_controller.AssignCurrenttime(MovingFeatureListClass.beginningTime);
    SimTimePicker.Time := MovingFeatureListClass.beginningTime;
    SimDatePicker.Date := MovingFeatureListClass.beginningTime;
