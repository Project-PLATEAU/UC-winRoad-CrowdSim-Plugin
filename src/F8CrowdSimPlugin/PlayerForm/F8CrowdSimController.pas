...
type
    ...
    F8CrowdSimControllerClass = class
        ...
        public
            constructor Create(const application: IF8ApplicationServices);
...
constructor F8CrowdSimControllerClass.Create(const application: IF8ApplicationServices);
    begin
...
procedure F8CrowdSimControllerClass.UpdateTimer(const dTimeInSeconds: Double);
    begin
    p_currentTime := IncMilliSecond(p_currentTime, Round(dTimeInSeconds * 1000* p_playingSpeed));
